...
#
# Then run the script:
#   ./deploy.sh 1 0x742d35Cc6634C0532925a3b844Bc454e4438f44e 0x000000000000000000000000000000000000dEaD 1000000000000000000 3600
#
...
#
# 3. burn_h160_address: Ethereum address where slashed collateral is sent (H160 format)
#    Example: 0x000000000000000000000000000000000000dEaD (burn address)
#
# 4. min_collateral_increase_u256: Minimum amount for deposits/reclaims in wei
#    Example: 1000000000000000000 (= 1 TAO in wei)
#
# 5. deny_timeout_u64: Time window in seconds for trustee to deny reclaim requests
...
forge create src/Collateral.sol:Collateral \
    ...
    --constructor-args "$NETUID" "$TRUSTEE_ADDRESS" "$BURN_ADDRESS" "$MIN_COLLATERAL_INCREASE" "$DENY_TIMEOUT"
